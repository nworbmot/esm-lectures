...
\begin{frame}{Low cost of renewable energy 2017 (NB: ignores variability)}
...
\begin{frame}[fragile]
  \frametitle{Energy System Design: Research Questions}
...
\begin{columns}[T]
  \begin{column}{9cm}
    ...
    \vspace{.2cm}
  \begin{itemize}
  \item What \alert{infrastructure} does a highly renewable energy system
    require?
  \item \alert{Where} should it go? And \alert{when}?
  \item Given a desired \co2 reduction, how much will it \alert{cost}?
    \item How to deal with the \alert{variability}  of wind and solar?
  \end{itemize}
  ...
  Researchers deal with these questions by solving large \alert{optimisation} problems.
  \end{column}
  \begin{column}{4.5cm}
    \vspace{.2cm}
  \includegraphics[width=4.7cm]{goat-clean}
  \end{column}
\end{columns}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Take account of social and political constraints}
...
\includegraphics[width=5cm]{nein_zur_monstertrasse}
  ...
  The Energy Transition is not just a case of ``cost optimisation
  under CO${}_2$ constraints''.  There are also \alert{social and political constraints}.

  We need to assess:
  \begin{itemize}
    \item Reducing need for transmission using \alert{storage / sector coupling} (e.g. battery electric vehicles, thermal storage)
    \item \alert{New technologies} that can minimise the landscape impact of transmission
    \item \alert{Efficiency} and \alert{sufficiency} to reduce demand
  \end{itemize}

  \vspace{0.2cm}

  \alert{Transparency is critical} for public acceptance.
  \end{column}
...
\section{Variability of Wind, Solar \& Demand}


\begin{frame}
  \frametitle{Variability: Different wind conditions over Europe}

  Wind, solar and demand vary at different time scales, e.g. wind is
  particularly affected by large weather
  systems at the \alert{continental scale} that pass in 1-2 weeks. See videos of \href{https://www.youtube.com/watch?v=ttfuEnMz2UM}{wind} and \href{https://www.youtube.com/watch?v=XqJAD666Elk}{solar}.

  \centering
  \includegraphics[width=10cm]{2015-11-30-0300.png}
...
\begin{frame}
  ...
  \centering
  \includegraphics[width=14cm]{DE-onwind-spectrum}
...
\begin{frame}
  ...
  \centering
  \includegraphics[width=14cm]{DE-solar-spectrum}
...
\begin{frame}
  ...
  \centering
  \includegraphics[width=11cm]{costs_ct_N1_5_HFOM-diw2030_solar1_7-LVs_0-0_0-25_Opt-eps-converted-to.pdf}
...
\begin{frame}
  ...
  \includegraphics[width=11cm]{local_marginal_price_ct_N1_5-diw2030_solar1_7_angles-LVs_0-0_0-25_Opt-eps-converted-to.pdf}
...
\section{Electricity, Heat and Transport}


\begin{frame}
  \frametitle{Include other sectors: heating and land transport}

  Electricity,  (low-temperature) heating and land transport cover 77\% of 2015 CO$_2$ emissions:
...
\begin{frame}
  ...
  \begin{columns}[T]
    \begin{column}{9cm}
      \includegraphics[width=9cm]{RGI-t-0.pdf}
...
\begin{frame}
  \frametitle{Idea of Open Energy Modelling}
  ...
  \centering
  \includegraphics[width=13cm]{open-model-process}

  \vspace{0.1cm}
  \centering
  \large
  \textbf{Open data + free software $\Rightarrow$ Transparency + Reproducibility}
  ...
  \includegraphics[width=8cm]{openmod-logo-large}
...
\begin{frame}
  ...
  Our free software PyPSA is online at \url{https://pypsa.org/} and on
  github. It can do:
...
\begin{columns}[T]
  ...
  \item \alert{Linear optimal power flow} (LOPF) (multiple periods, unit commitment,
    ...
    \item Total electricity system \alert{investment optimisation}
  \end{itemize}
